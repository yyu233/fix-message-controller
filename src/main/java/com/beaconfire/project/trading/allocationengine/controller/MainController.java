...
import com.beaconfire.project.trading.allocationengine.dto.in.FixMessageRequest;
...
public class MainController {
    ...
    @PostMapping("/publish")
    public ResponseEntity<String> publishFIXMessage(@RequestBody FixMessageRequest request) {
        String fixId = request.getFixId();
        String fixMessage = request.getFixMessage();
        ...
        fixInfoRecordedEvent.setFixId(fixId);
        fixInfoRecordedEvent.setFixString(fixMessage);
        AvroMessageConverter<com.beaconfire.project.trading.allocationengine.domain.FixInfoRecordedEvent> messageConverter = new AvroMessageConverter<>(
                schemaRegistryUrl);
        EventPublisher<com.beaconfire.project.trading.allocationengine.domain.FixInfoRecordedEvent> avroEventPublisher = new EventPublisher<>(
                producerFactory, properties, messageConverter);
